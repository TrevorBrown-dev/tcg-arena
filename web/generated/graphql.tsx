...
export type MyCardLibraryQuery = { __typename?: 'Query', myCardLibrary: Array<{ __typename?: 'CardRecord', amount: number, card: { __typename?: 'Card', name: string, description: string, imageUrl?: string | null } }> };
